...
def func_find_daily_chaps():
    ...
    url_counter = 0
    url_list = ['https://leviatanscans.com/comics/i-am-the-sorcerer-king/', 'https://leviatanscans.com/comics/chronicles-of-heavenly-demon',
    ...
    #Mangatx
    url_counter = 0
    url_list = ['https://mangatx.com/manga/battle-through-the-heavens/', 'https://mangatx.com/manga/wu-dong-qian-kun/']
